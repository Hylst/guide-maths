  ...
  return (
    <div className="max-w-5xl mx-auto pb-16">
      ...
      <Section title="📜 Couple de Variables & Matrice de Covariance" icon="👯" color="amber">
        <p className="mb-4">
          C'est là que réside 100% de la Machine Learning et la prévision de la bourse. Si tu étudies X (la Température) et Y (les Ventes de Glaces), ces deux variables 'tournent' en même temps.
        </p>
      ...
      <Section title="🎮 Simulateur TCL" icon="🕹️" color="slate">
        <FillInTheBlanks 
          id="pb-proba-eval"
          content={[
