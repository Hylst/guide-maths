  ...
  return (
    <div className="max-w-5xl mx-auto pb-16">
      ...
      <Section title="📜 Théorème de d'Alembert-Gauss" icon="🗡️" color="amber">
        ...
        <div className="mt-4 p-4 border border-amber-100 dark:border-amber-800/60 bg-amber-50/50 dark:bg-amber-900/20 rounded-xl text-amber-950 dark:text-amber-50 text-sm">
      ...
      <Section title="🎮 Simulateur de Racines" icon="🕹️" color="slate">
        <FillInTheBlanks 
          id="pb-cpx-eval"
          content={[
