...
const Course_Maternelle_GS_01_Quantites: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8">
      ...
      <InfoBlock type="info" title="Zoom sur la dizaine (Le nombre 10)">
        Le nombre 10 possède un statut magique dans notre vie : nous avons 10 doigts, nous comptons en base 10, et c'est le tout premier nombre à deux chiffres ! Le &apos;1&apos; représente une boîte complète (une dizaine) et le &apos;0&apos; indique qu'il ne reste aucune unité séparée.
      </InfoBlock>
      ...
      <Section title="Exercice Interactif : La Cueillette" color="emerald" icon="▶️">
