...
const Course_Terminale_Comp_03_Statistiques_Ajustement: React.FC = () => {
  ...
  const courseId = "/Cours_Math/03_Lycee/Terminale_Complementaires/03_Terminale_Comp_03_Statistiques_Ajustement.md";
      ...
      <Section title="Quiz d'évaluation" color="indigo" icon="🎯">
        <Quiz 
          questions={[
            ...
            {
              question: "La méthode des moindres carrés cherche à minimiser la valeur de :",
