...
const Course_Terminale_Comp_02_Fonctions_Appliquees: React.FC = () => {
  ...
  const courseId = "/Cours_Math/03_Lycee/Terminale_Complementaires/02_Terminale_Comp_02_Fonctions_Appliquees.md";
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8">
      ...
      <Section title="L'Élasticité de la Demande" color="indigo" icon={<Activity className="text-indigo-500 w-6 h-6"/>}>
        <div className="space-y-4">
          <p>
            Le concept économique d'<strong>élasticité</strong> de la demande par rapport au prix {"$p$"} est le rapport mesurant la variation relative de la demande provoquée par une hausse relative de 1% du prix.
          </p>
          ...
          questions={[
            {
              ...
              options: ["5x + 10", "10x + 10", "15x"],
              correctAnswer: 1,
              explanation: "Le coût marginal s'assimile à la dérivée C'(x). La dérivée de 5x^2 + 10x is 10x + 10."
            },
            {
