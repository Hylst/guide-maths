  ...
  return (
    <div className="max-w-5xl mx-auto pb-16">
      ...
      <Section title="⚠️ Introduction : Tableaux de Nombres" icon="📊" color="emerald">
        <p>
          Si tu veux calculer les notes de 3 élèves sur 4 matières, tu as 12 nombres à gérer. Dans la finance ou l'IA, on gère des millions de données simultanément. Pour ça, on va utiliser des tableaux géants que l'on appelle des <strong>Matrices</strong>.
        </p>
        <p className="mt-2">
