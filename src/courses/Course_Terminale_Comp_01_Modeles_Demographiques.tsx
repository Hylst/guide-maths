...
const Course_Terminale_Comp_01_Modeles_Demographiques: React.FC = () => {
  ...
  const courseId = "/Cours_Math/03_Lycee/Complementaires/01_Terminale_Comp_01_Modeles_Demographiques.md";
      ...
      <Section title="La théorie de croissance illimitée (Malthus)" color="slate" icon={<TrendingUp className="text-indigo-600 w-6 h-6"/>}>
        <div className="space-y-4">
          ...
          <TipBanner type="warning" title="Limites évidentes du modèle">
            Ce modèle est pertinent pour de courtes périodes ou des milieux aux ressources infinies (ex: des bactéries dans une boîte de Pétri fraîche). Néanmoins, dans la vie réelle, la nourriture et l'espace sont limités, empêchant une croissance exponentielle éternelle.
          </TipBanner>
        </div>
      </Section>
          ...
          questions={[
            {
              ...
              options: ["La population double", "La population diminue de moitié", "La population reste exactement égale à K"],
              correctAnswer: 2,
