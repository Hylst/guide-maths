...
const Course_Primaire_CE2_01_Nombres_jusqua_10000: React.FC<{
  ...
  return (
    <div className="max-w-5xl mx-auto pb-16">
      ...
      <InfoBlock type="reminder" title="Rappel de CE1 : Souviens-toi des boîtes de rangement !">
        Avant de découvrir le royaume des dizaines de milliers, rappelle-toi les trois boîtes de rangement des petits nombres :
        <br />- <strong>10 Unités</strong> (petits cubes) font exactement 1 Dizaine (une barre de 10).
        <br />- <strong>10 Dizaines</strong> (barres de 10) font exactement 1 Centaine (une plaque de 100).
        <br />Aujourd&apos;hui, nous découvrons ce qu&apos;il se passe quand on fabrique 10 plaques de 100 !
      </InfoBlock>
      ...
      <InfoBlock type="info" title="Zoom sur : Les gardiens silencieux (Le rôle indispensable du chiffre Zéro)">
        Dans un nombre comme 5 004, le zéro n&apos;est pas là pour faire décoration. Si on ne l&apos;utilisait pas, on écrirait 54, ce qui représente seulement 5 dizaines et 4 unités ! Nos deux petits zéros sont de véritables gardiens du temple qui crient : « Attention ! Il n&apos;y a pas de centaine ni de dizaine aujourd&apos;hui, mais la place est réservée pour que le 5 reste bien au rang des milliers à la quatrième position ! »
      </InfoBlock>
      ...
      <InfoBlock type="funfact" title="Le saviez-vous ? L'origine du mystérieux « K » pour mille">
        Dans les jeux vidéo ou sur Internet, tu as peut-être déjà vu écrit « 5K » pour signifier 5 000. Ce mystérieux « K » vient du grec ancien « Kilo » qui veut dire mille. C&apos;est exactement pour cela qu&apos;un kilogramme fait 1 000 grammes, et qu&apos;un kilomètre fait 1 000 mètres !
      </InfoBlock>
