    ...
    <div className="max-w-5xl mx-auto pb-16">
      <CourseHeader 
        ...
        objectives={[
          ...
          "Lire, Écrire et Décomposition les nombres jusqu'à 999.",
          "Comparer des nombres (Plus grand / Plus petit)."
        ]}
      />

      <InfoBlock type="reminder" title="Rappel de CP : Le Tableau d'Unités et Dizaines">
        Avant de découvrir la centaine, souviens-toi qu&apos;une <strong>dizaine</strong> regroupe exactement 10 unités individuelles. Quand tu dépasses 9 unités, les blocs s&apos;assemblent en barre !
      </InfoBlock>
      ...
      <InfoBlock type="info" title="Zoom sur : Le rôle silencieux mais crucial du chiffre Zéro">
        Dans un nombre comme 304, le chiffre du milieu est 0. Il est indispensable ! Sans lui, le nombre s&apos;écrirait 34, ce qui représente seulement 3 dizaines et 4 unités. Le zéro sert de gardien pour crier : « Attention, il n&apos;y a pas de dizaine, mais la centaine est bien là à la troisième place ! »
      </InfoBlock>
      ...
      <InfoBlock type="funfact" title="Le saviez-vous ? L'origine historique du mot centum">
        Le mot « Cent » vient du latin « centum ». Autrefois, pour compter de grandes collections d&apos;animaux ou d&apos;objets sans se tromper, les scribes ou bergers faisaient des encoches sur des bâtons en bois toutes les dix unités, et une immense encoche croisée à la centième !
      </InfoBlock>
