...
const Course_Primaire_CE1_02_Addition_posee_et_Soustraction: React.FC<{
  ...
  return (
    <div className="max-w-5xl mx-auto pb-16">
      ...
      <InfoBlock type="reminder" title="Rappel de CP : Les compléments à 10 et les petits calculs">
        Avant de poser en colonnes, souviens-toi de tes tables d&apos;addition de base (comme 7 + 3 = 10, 8 + 2 = 10). Elles t&apos;aideront à repérer immédiatement quand une colonne va fabriquer une retenue !
      </InfoBlock>
      ...
      <InfoBlock type="info" title="Zoom sur : Les secrets de la retenue volante">
        Pourquoi appelle-t-on cela une « retenue » ? Parce que tu la gardes en mémoire (tu la « retiens ») tout en haut de ton calcul pendant que tu termines de t&apos;occuper des unités. C&apos;est comme un petit soldat de réserve qui attend sagement que la bataille des dizaines commence !
      </InfoBlock>
      ...
      <InfoBlock type="funfact" title="Le saviez-vous ? L'invention de l'addition en colonnes">
        Le calcul en colonnes que tu apprends aujourd&apos;hui a été perfectionné il y a plus de mille ans par Al-Khwarizmi, un immense mathématicien. Avant lui, les gens utilisaient des bouliers de bois ou devaient tracer des lignes de sable pour ne pas s&apos;emmêler les pinceaux !
      </InfoBlock>
