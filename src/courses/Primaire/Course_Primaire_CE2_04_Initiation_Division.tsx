...
const Course_Primaire_CE2_04_Initiation_Division: React.FC<{
  ...
  return (
    <div className="max-w-5xl mx-auto pb-16">
      ...
      <InfoBlock type="reminder" title="Rappel : Les tables de multiplication">
         Pour diviser rapidement, tu dois être un champion des tables de multiplication. N&apos;oublie pas que diviser, c&apos;est tout simplement faire une multiplication à l&apos;envers ! Par exemple, si tu sais que 3 x 4 = 12, alors tu sais immédiatement que 12 divisé par 3 vaut 4 !
      </InfoBlock>
      ...
      <InfoBlock type="funfact" title="Le saviez-vous ? L'origine rigolote du symbole de division (÷)">
        Le symbole de la division s&apos;appelle l&apos;<strong>obélus</strong> (÷). Il a été inventé il y a très longtemps. Le petit trait horizontal représente le partage, et les deux petits points (un en haut, un en bas) représentent les parts égales et équitables distribuées de chaque côté !
      </InfoBlock>
      ...
      <InfoBlock type="info" title="Zoom sur : Les 4 mousquetaires de la division">
        La division utilise des mots très précis qu&apos;il faut connaître :
        <br />- Le <strong>Dividende</strong> (14) : ce que l&apos;on veut partager.
        <br />- Le <strong>Diviseur</strong> (3) : le nombre de parts que l&apos;on fait.
        <br />- Le <strong>Quotient</strong> (4) : ce que chacun reçoit.
        <br />- Le <strong>Reste</strong> (2) : ce qu&apos;il reste quand le partage équitable est fini.
      </InfoBlock>
