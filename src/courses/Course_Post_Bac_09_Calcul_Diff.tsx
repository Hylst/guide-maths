  ...
  return (
    <div className="max-w-5xl mx-auto pb-16">
      ...
      <Section title="📜 La Différentielle Absolue (Matrice Jacobienne)" icon="🕸️" color="amber">
        <p className="mb-4">
          Si votre fonction retourne un Vecteur (et non un simple nombre d'altitude). Par exemple un courant de vent F(x,y,z) = (VentX, VentY, VentZ). Alors on ne peut plus faire un gradient.
        </p>
      ...
      <Section title="🎮 Simulateur de Points Critiques" icon="🕹️" color="slate">
        <FillInTheBlanks 
          id="pb-diff-eval"
          content={[
